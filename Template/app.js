(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/321.loader.js";
    var config = {
        dataUrl: buildUrl + "/321.data",
        frameworkUrl: buildUrl + "/321.framework.js",
        codeUrl: buildUrl + "/321.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "DefaultCompany",
        productName: "WEBGLresponsive",
        productVersion: "0.1",
    };
